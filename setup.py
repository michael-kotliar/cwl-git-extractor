...
setup(
    name="cwl-git-extractor",
    description="",
    long_description=open(README, "r+", encoding="utf-8").read(),
    long_description_content_type="text/markdown",
    version="1.0",
    url="https://github.com/michael-kotliar/cwl-git-extractor",
    download_url="https://github.com/michael-kotliar/cwl-git-extractor",
    ...
    entry_points={
        'console_scripts': [
            "cwl-git-extractor=cwl_git_extractor.main:main"
        ]
    },
    classifiers=[
